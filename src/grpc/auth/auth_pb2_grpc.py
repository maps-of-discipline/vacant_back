...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPayload = channel.unary_unary(
            "/auth.AuthService/GetPayload",
            request_serializer=auth__pb2.GetPayloadRequest.SerializeToString,
            response_deserializer=auth__pb2.GetPayloadResponse.FromString,
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "GetPayload": grpc.unary_unary_rpc_method_handler(
            servicer.GetPayload,
            request_deserializer=auth__pb2.GetPayloadRequest.FromString,
            response_serializer=auth__pb2.GetPayloadResponse.SerializeToString,
        ),
...
class AuthService(object):
    ...
    def GetPayload(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/auth.AuthService/GetPayload",
            auth__pb2.GetPayloadRequest.SerializeToString,
            auth__pb2.GetPayloadResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
